...
{
    class MatDalInitParams : InitParamsImpl
    {
    }

    [Export("MSSQL", typeof(IMatDal))]
    public class MatDal: SQLDal, IMatDal
    {
        public IInitParams CreateInitParams()
        {
            return new MatDalInitParams();
        }
        ...
        {
            Mat result = default(Mat);

            using (SqlConnection conn = OpenConnection())
            {
                SqlCommand cmd = new SqlCommand("p_Mat_GetDetails", conn);
                ...
                {
                    result = MatFromRow(ds.Tables[0].Rows[0]);                    
                }
            }
        ...
        public bool Delete(System.Int64? ID)
        {
            ...
            using (SqlConnection conn = OpenConnection())
            {
                SqlCommand cmd = new SqlCommand("p_Mat_Delete", conn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public bool Erase(System.Int64? ID)
        {
            ...
            using (SqlConnection conn = OpenConnection())
            {
                SqlCommand cmd = new SqlCommand("p_Mat_Erase", conn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                            AddParameter(   cmd, "@ID", System.Data.SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, string.Empty, DataRowVersion.Current, ID);
        ...
        {
            var entitiesOut = base.GetBy<Mat, System.Int64>("p_Mat_GetByCreatedByID", CreatedByID, "@CreatedByID", SqlDbType.BigInt, 0, MatFromRow);

            return entitiesOut;
        }
                public IList<Mat> GetByModifiedByID(System.Int64? ModifiedByID)
        {
            var entitiesOut = base.GetBy<Mat, System.Int64?>("p_Mat_GetByModifiedByID", ModifiedByID, "@ModifiedByID", SqlDbType.BigInt, 0, MatFromRow);

            return entitiesOut;
        }
        
        public IList<Mat> GetAll()
        {
            IList<Mat> result = base.GetAll<Mat>("p_Mat_GetAll", MatFromRow);

            return result;
        }

        public Mat Insert(Mat entity) 
        {
            Mat entityOut = base.Upsert<Mat>("p_Mat_Insert", entity, AddUpsertParameters, MatFromRow);

            return entityOut;
        }

        public Mat Update(Mat entity) 
        {
            Mat entityOut = base.Upsert<Mat>("p_Mat_Update", entity, AddUpsertParameters, MatFromRow);

            return entityOut;
        }

        protected SqlCommand AddUpsertParameters(SqlCommand cmd, Mat entity)
        {
                SqlParameter pID = new SqlParameter("@ID", System.Data.SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, "ID", DataRowVersion.Current, (object)entity.ID != null ? (object)entity.ID : DBNull.Value);   cmd.Parameters.Add(pID); 
                SqlParameter pMatName = new SqlParameter("@MatName", System.Data.SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "MatName", DataRowVersion.Current, (object)entity.MatName != null ? (object)entity.MatName : DBNull.Value);   cmd.Parameters.Add(pMatName); 
        ...
        protected Mat MatFromRow(DataRow row)
        {
            var entity = new Mat();

                    entity.ID = !DBNull.Value.Equals(row["ID"]) ? (System.Int64?)row["ID"] : default(System.Int64?);
                    entity.MatName = !DBNull.Value.Equals(row["MatName"]) ? (System.String)row["MatName"] : default(System.String);
