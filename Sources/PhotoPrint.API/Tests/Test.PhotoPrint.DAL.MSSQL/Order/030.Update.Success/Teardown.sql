...
DECLARE @updUserID BIGINT = 100007
DECLARE @updContactID BIGINT = 100008
DECLARE @updDeliveryAddressID BIGINT = 100010
DECLARE @updDeliveryServiceID BIGINT = 100008
DECLARE @updComments NVARCHAR(1000) = 'Comments bad23f4418514fd5a0087205ee4379db'
DECLARE @updIsDeleted BIT = 1
DECLARE @updCreatedDate DATETIME = '9/11/2021 11:10:33 AM'
DECLARE @updCreatedByID BIGINT = 100005
DECLARE @updModifiedDate DATETIME = '7/21/2024 11:37:33 AM'
