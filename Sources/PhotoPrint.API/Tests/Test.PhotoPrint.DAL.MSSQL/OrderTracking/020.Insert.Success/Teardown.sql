...
DECLARE @SetDate DATETIME = '5/20/2023 11:01:33 AM'
DECLARE @SetByID BIGINT = 100011
DECLARE @Comment NVARCHAR(1000) = 'Comment ef0d29efbe584a5491ab16ae2315ce58'
...
IF(@Fail = 1) 
BEGIN
	THROW 51001, 'OrderTracking was not inserted', 1
END