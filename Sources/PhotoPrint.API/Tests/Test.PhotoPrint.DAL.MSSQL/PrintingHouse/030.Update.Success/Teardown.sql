...
DECLARE @Name NVARCHAR(50) = 'Name 8f16bef648b04daba43eac1852f41ee6'
DECLARE @Description NVARCHAR(1000) = 'Description 8f16bef648b04daba43eac1852f41ee6'
DECLARE @IsDeleted BIT = 0
DECLARE @CreatedDate DATETIME = '8/14/2020 5:29:33 AM'
DECLARE @CreatedByID BIGINT = 100007
DECLARE @ModifiedDate DATETIME = '6/25/2023 3:16:33 PM'
DECLARE @ModifiedByID BIGINT = 100009
 
-- updated values --

DECLARE @updID BIGINT = NULL
DECLARE @updName NVARCHAR(50) = 'Name f3b901d4779a4ea4b59d2d0d2bdcba67'
DECLARE @updDescription NVARCHAR(1000) = 'Description f3b901d4779a4ea4b59d2d0d2bdcba67'
DECLARE @updIsDeleted BIT = 0
DECLARE @updCreatedDate DATETIME = '6/25/2023 3:16:33 PM'
DECLARE @updCreatedByID BIGINT = 100010
DECLARE @updModifiedDate DATETIME = '11/12/2020 1:03:33 AM'
