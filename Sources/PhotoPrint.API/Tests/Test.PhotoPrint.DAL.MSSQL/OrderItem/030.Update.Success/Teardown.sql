...
DECLARE @updImageID BIGINT = 100003
DECLARE @updWidth INT = 151
DECLARE @updHeight INT = 151
DECLARE @updSizeID BIGINT = 100010
DECLARE @updFrameTypeID BIGINT = 100018
DECLARE @updFrameSizeID BIGINT = 100008
DECLARE @updMatID BIGINT = 100004
DECLARE @updMaterialTypeID BIGINT = 100002
DECLARE @updMountingTypeID BIGINT = 100003
DECLARE @updItemCount INT = 718
DECLARE @updPriceAmountPerItem DECIMAL(18, 2) = 777
DECLARE @updPriceCurrencyID BIGINT = 144
DECLARE @updComments NVARCHAR(1000) = 'Comments 2d882d9b320742bcb2d2ff7295612622'
DECLARE @updPrintingHouseID BIGINT = 100004
DECLARE @updIsDeleted BIT = 1
DECLARE @updCreatedDate DATETIME = '8/14/2020 12:25:49 PM'
DECLARE @updCreatedByID BIGINT = 100002
DECLARE @updModifiedDate DATETIME = '8/14/2020 12:25:49 PM'
