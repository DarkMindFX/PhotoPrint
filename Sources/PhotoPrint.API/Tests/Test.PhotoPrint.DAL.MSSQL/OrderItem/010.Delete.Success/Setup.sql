...
DECLARE @Width INT = 552
DECLARE @Height INT = 552
DECLARE @SizeID BIGINT = 100011
DECLARE @FrameTypeID BIGINT = 100015
DECLARE @FrameSizeID BIGINT = 100007
DECLARE @MatID BIGINT = 100010
DECLARE @MaterialTypeID BIGINT = 100004
DECLARE @MountingTypeID BIGINT = 100008
DECLARE @ItemCount INT = 164
DECLARE @PriceAmountPerItem DECIMAL(18, 2) = 555
DECLARE @PriceCurrencyID BIGINT = 112
DECLARE @Comments NVARCHAR(1000) = 'Comments b3cf31320c304ddb8663fd6e996fce46'
DECLARE @PrintingHouseID BIGINT = 100003
DECLARE @IsDeleted BIT = 1
DECLARE @CreatedDate DATETIME = '4/23/2023 5:37:49 AM'
DECLARE @CreatedByID BIGINT = 100007
DECLARE @ModifiedDate DATETIME = '9/9/2020 6:04:49 AM'
