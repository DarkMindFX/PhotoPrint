...
class ContactTypesPage extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={{ height: 500, width: '100%' }}>
                ...
                <Button variant="contained" component={Link} color="primary" size="small" to={this.state.urlNewEntity} >+ ContactType</Button>        
            </div>
        );
    }
    ...
    _initColumns() {
        this._columns = [
                ...
                { field: 'ContactTypeName', headerName: 'ContactTypeName', width: 250 },
    ...
    _getRecords() {
        ...
        let cs = Object.values(this.state.contacttypes);
        ...
        for(let c in cs) {
            ...
            let r = {
                id: cs[c].ID,
                ID: cs[c].ID,
                ContactTypeName: cs[c].ContactTypeName,
...
export default withRouter(ContactTypesPage);