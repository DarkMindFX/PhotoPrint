    ...
    _getRecords() {
        ...
        for(let c in cs) {
            ...
            let r = {
                ...
                Width: cs[c].Width,
                Height: cs[c].Height,
                SizeID: cs[c].SizeID ? this.state.sizes[ cs[c].SizeID ].SizeName : "",
                FrameTypeID: cs[c].FrameTypeID ? this.state.frametypes[ cs[c].FrameTypeID ].FrameTypeName : "",
                FrameSizeID: cs[c].FrameSizeID ? this.state.sizes[ cs[c].FrameSizeID ].SizeName : "",
                MatID: cs[c].MatID ? this.state.mats[ cs[c].MatID ].MatName : "",
                MaterialTypeID: cs[c].MaterialTypeID ? this.state.materialtypes[ cs[c].MaterialTypeID ].MaterialTypeName : "",
                MountingTypeID: cs[c].MountingTypeID ? this.state.mountingtypes[ cs[c].MountingTypeID ].MountingTypeName : "",
