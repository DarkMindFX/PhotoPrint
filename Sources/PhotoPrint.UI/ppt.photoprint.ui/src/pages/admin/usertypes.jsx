...
class UserTypesPage extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { 
            ...
            showError: false,
            error: null,
            urlThis: `${rooPath}/usertypes`,
            urlNewEntity: `${rooPath}/usertype/new`,
            urlEditEntity: `${rooPath}/usertype/edit/`,
        };
        this._initColumns();
    ...
    render() {
        ...
        return (
            <div style={{ height: 500, width: '100%' }}>
                ...
                <Button variant="contained" component={Link} color="primary" size="small" to={this.state.urlNewEntity} >+ UserType</Button>        
            </div>
        );
    }
    ...
    _initColumns() {
        this._columns = [
                ...
                { field: 'UserTypeName', headerName: 'UserTypeName', width: 250 },
    ...
    _getRecords() {
        ...
        let cs = Object.values(this.state.usertypes);
        ...
        for(let c in cs) {
            ...
            let r = {
                id: cs[c].ID,
                ID: cs[c].ID,
                UserTypeName: cs[c].UserTypeName,
...
export default withRouter(UserTypesPage);