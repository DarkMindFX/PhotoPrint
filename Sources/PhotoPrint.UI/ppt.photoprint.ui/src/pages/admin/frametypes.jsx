...
class FrameTypesPage extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { 
            ...
            showError: false,
            error: null,
            urlThis: `${rooPath}frametypes`,
            urlNewEntity: `${rooPath}frametype/new`,
            urlEditEntity: `${rooPath}frametype/edit/`,
        };
        this._initColumns();
    ...
    render() {
        ...
        return (
            <div style={{ height: 500, width: '100%' }}>
                ...
                <Button variant="contained" component={Link} color="primary" size="small" to={this.state.urlNewEntity} >+ FrameType</Button>        
            </div>
        );
    }
    ...
    _initColumns() {
        this._columns = [
                ...
                { field: 'FrameTypeName', headerName: 'FrameTypeName', width: 250 },
    ...
    _getRecords() {
        ...
        let cs = Object.values(this.state.frametypes);
        ...
        for(let c in cs) {
            ...
            let r = {
                id: cs[c].ID,
                ID: cs[c].ID,
                FrameTypeName: cs[c].FrameTypeName,
...
export default withRouter(FrameTypesPage);