...
class PaymentMethodsPage extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { 
            ...
            showError: false,
            error: null,
            urlThis: `${rooPath}paymentmethods`,
            urlNewEntity: `${rooPath}paymentmethod/new`,
            urlEditEntity: `${rooPath}paymentmethod/edit/`,
        };
        this._initColumns();
    ...
    render() {
        ...
        return (
            <div style={{ height: 500, width: '100%' }}>
                ...
                <Button variant="contained" component={Link} color="primary" size="small" to={this.state.urlNewEntity} >+ PaymentMethod</Button>        
            </div>
        );
    }
    ...
    _getRecords() {
        ...
        let cs = Object.values(this.state.paymentmethods);
